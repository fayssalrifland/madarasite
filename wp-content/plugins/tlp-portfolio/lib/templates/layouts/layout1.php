...
if(in_array( 'project_url', $items ) && $project_url){
    $exFeature .= '<li class="project-url"><label>'.__("Project URL :", 'tlp-portfolio').'</label><a  href="' . esc_url($project_url) . '" '.$link_target.'>'.esc_url($project_url).'</a></li>';
}
...
if ($img) {
    $imgWithHtml = sprintf('<div class="tlp-portfolio-thum tlp-item">
                %s
...
<div class="<?php echo esc_attr($grid) ?>">
    <div class="tlp-portfolio-item">
        <?php if( $project_title || $exFeature ) { ?>
            <?php $imgWithHtml .= sprintf('<div class="tlp-content">
