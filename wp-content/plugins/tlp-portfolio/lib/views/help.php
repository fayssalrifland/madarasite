...
?>
	...
	<div class="rtport-help-wrapper" >
		...
		<div class="rtport-call-to-action" style="background-image: url('<?php echo $TLPportfolio->assetsUrl; ?>images/admin/banner.png')">
				...
				<div class="rtport-testimonials">
					<div class="rtport-testimonial">
						...
						<div class="client-info">
							<img src="<?php echo $TLPportfolio->assetsUrl; ?>images/admin/client1.png">
							<div>
					...
					<div class="rtport-testimonial">
						...
						<div class="client-info">
							<img src="<?php echo $TLPportfolio->assetsUrl; ?>images/admin/client2.png">
							<div>
								<div class="rtport-star">
									<i class="dashicons dashicons-star-filled"></i>
									<i class="dashicons dashicons-star-filled"></i>
